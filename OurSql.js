exports.Model = function(tableName,mysqlclient){	
    var mminstance = function(){
		var mi = this;
    	mminstance.prototype._get_defs = function(callback){
    		if(!mi.defs){
    	...
    	mminstance.prototype._filter_vals = function(instance,defs){
    		var toUpdateVals = {};
    	...
    	mi.Instance = function(userObj){
			...
			mi.Instance.prototype.update = function(callback){
			...
			mi.Instance.prototype.create = function(callback){
				var toUpdateVals = {};
				mi._get_defs(function(err,defs){
			...
			mi.Instance.prototype.save = function(callback){
